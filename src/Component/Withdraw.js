...
function Withdraw() {
    ...
    if(dt.length > 0){
        ...
        if(camt >= parseInt(a)) {
                ...
                var tr = {"acno":ac,"Ammount":a,"date":date,"type":"Withdraw"}
            ...
            setMsg("Invalid Account Or Pin Number")
    ...
    return (
        <div >
            <center style={{ "background": "skyblue" }}><h1 className="display-3">Withdraw Ammount</h1><br/>
                <h3 >{Msg}</h3><hr />
            ...
            <div className="row" style={{ "background": "pink" }}>
                ...
                <div className="col-md-5" >
                    ...
                    <b>Enter your Ammount to Withdraw</b>
                    <input type="text" className="form-control" onInput={(e) => setAmt(e.target.value)}></input>
                    <br /><br />
                    <div className="row">
                        <div className="col">
                            <button className="btn btn-success" onClick={() => getWithdraw()}>Withdraw</button>
                        </div>
                    </div><br/><br/>
